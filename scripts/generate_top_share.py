#!/usr/bin/env python3
"""
Generate share/[en/]top.html — the top-page share landing.

Mirrors generate_share_pages.py but for a single non-score variant. The OGP
image points at og/[en/]cover.png so X / Slack render the brand cover when
someone shares the top page itself.

Usage:
    python3 scripts/generate_top_share.py [--lang ja|en]
"""
import argparse
import os
...
<meta property="og:url" content="__SITE_URL__/share{lang_seg}/top.html">
<meta property="og:image" content="__SITE_URL__/og{lang_seg}/cover.png">
...
<meta name="twitter:image" content="__SITE_URL__/og{lang_seg}/cover.png">
...
def main():
    ...
    path = os.path.join(out_dir, "top.html")
