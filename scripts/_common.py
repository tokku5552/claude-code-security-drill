...
SHARE_STRINGS = {
    "ja": {
        "html_lang": "ja",
        "page_title": "Claude Codeセキュリティ理解度チェック — {score}点 ({rank})",
        "og_title": "Claude Codeセキュリティ理解度チェックで {score}点 とった！",
        "og_desc": "{rank} ランク。Claude Codeを使うすべての人のためのセキュリティ・クイズ全10問。あなたのスコアは？",
        "tw_desc": "{rank} ランク。あなたも試してみる?",
        "label": "// SHARED RESULT",
        "headline_html": 'Claude Codeセキュリティ理解度チェックで<br><span class="score">{score}点</span> でした',
        "rank_label": "RANK: {rank}",
        "body": "このクイズは、Claude Codeを使う人なら知っておきたいセキュリティの感覚を10問でチェックするものです。所要時間は約7分。",
        "cta": "あなたも挑戦する →",
        "repo_link": "↗ View on GitHub",
    },
    "en": {
        "html_lang": "en",
        "page_title": "Claude Code Security Quiz — {score} pts ({rank})",
        "og_title": "I scored {score} pts on the Claude Code Security Quiz!",
        ...
        "label": "// SHARED RESULT",
        "headline_html": 'I scored<br><span class="score">{score} pts</span><br>on the Claude Code Security Quiz',
        "rank_label": "RANK: {rank}",
        "body": "A 10-question quiz for everyone who uses Claude Code, sharpening the security instincts you'd want before something actually goes wrong. About 7 minutes.",
        "cta": "Take the quiz →",
        "repo_link": "↗ View on GitHub",
    },
}
